...
Click on [http://learn-co-curriculum.github.io/site-for-scraping/courses](this link) and once again scroll down to the section of the page that lists the course offerings. Right click on any course offering and select "inspect element". You should see something like this in your browser:
